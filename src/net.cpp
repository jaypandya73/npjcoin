...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Npjcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"139.59.58.213", "139.59.58.213"},
    {"139.59.2.133", "139.59.2.133"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Npjcoin is probably already running."), addrBind.ToString().c_str());
        else
